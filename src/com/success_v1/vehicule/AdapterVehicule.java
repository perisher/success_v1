...
public class AdapterVehicule extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		holder.id_vehicule.setText(vehicule.get(arg0).id);
		holder.marque_vehicule.setText(vehicule.get(arg0).marque);
		holder.modele_vehicule.setText(vehicule.get(arg0).modele);
		holder.motorisation_vehicule.setText(vehicule.get(arg0).motorisation);
		holder.tarifJour_vehicule.setText(vehicule.get(arg0).prix);

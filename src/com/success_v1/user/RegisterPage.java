...
public class RegisterPage extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnDateNais.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				Log.d("choice Spinner",spinGenre.getSelectedItem().toString());
	   	    	nbBtn=1;
    ...
    class AddUser extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) { 
            ...
            params.add(new BasicNameValuePair("genre_user", spinGenre.getSelectedItem().toString()));
            params.add(new BasicNameValuePair("codePost_user", editCodePost.getText().toString()));
            params.add(new BasicNameValuePair("ville_user", editVille.getText().toString()));
            params.add(new BasicNameValuePair("pays_user", editPays.getText().toString()));
            // getting JSON Object
